...
const topicDatabase = {
  ...
  easy: [
    ...
    {id: 146, text: 'スクーター', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 147, text: '自動車', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 148, text: 'トラック', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 149, text: '新幹線', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 150, text: '飛行機', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 151, text: '気球', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 152, text: '船', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 153, text: '桜', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 154, text: 'こいのぼり', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 155, text: 'ひまわり', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 156, text: 'スイカ', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 157, text: '銀杏', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 158, text: '木の葉の山', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 159, text: '雪だるま', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    {id: 160, text: 'ツリー', icon: '🔍', category: '街構造・乗り物', weight: 2500},
    ...
    {id: 401, text: '横断歩道ライン', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 402, text: '停止線_三角', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 403, text: '黄色中央線', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 404, text: '白中央線', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 405, text: '外側線', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 406, text: 'ひし形マーク', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 407, text: '停止三角', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 408, text: '直進矢印', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 409, text: '左折矢印', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 410, text: '右折矢印', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 411, text: '自転車ナビライン', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 412, text: 'バス停ライン', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 413, text: '減速マーク', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 414, text: 'スクールゾーン舗装', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 415, text: '緑舗装', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 416, text: '赤舗装', icon: '🔍', category: '線・模様観察', weight: 1500},
    {id: 417, text: '矢印の一部', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 418, text: '注意色のしましま', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 419, text: '黄色い注意プレート', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 420, text: '赤い注意プレート', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 421, text: '青い案内プレート', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 422, text: '緑の誘導表示', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 423, text: '消火設備マーク', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 424, text: '避難案内マーク', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 425, text: '駐輪禁止マーク', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 426, text: '駐車場マーク', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 427, text: '防犯カメラ表示', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 428, text: '工事中カラー', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 429, text: '反射材つき表示', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 430, text: '古いステッカー跡', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 431, text: '色あせた表示', icon: '🔍', category: '街インフラ', weight: 1500},
    {id: 432, text: '半分はがれた表示', icon: '🔍', category: '街インフラ', weight: 1500}
  ],
  ...
  medium: [
    ...
    {id: 353, text: '舗装の終わり', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 354, text: 'タイルの終端', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 355, text: '白線の終端', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 356, text: 'フェンスの終端', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 357, text: 'ガードレールの終端', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 358, text: '側溝の終端', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 359, text: 'ブロック塀の終端', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 360, text: '手すりの終端', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 361, text: '縁石の切れ目', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 362, text: '舗装と土の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 363, text: '舗装と草の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 364, text: '舗装と砂利の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 365, text: '壁と地面の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 366, text: '影の終端', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 367, text: '水たまりの縁', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 368, text: '落ち葉の縁', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 385, text: 'アスファルトとコンクリートの境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 386, text: 'コンクリートとタイルの境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 387, text: 'タイルと砂利の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 388, text: '土と草の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 389, text: '砂と石の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 390, text: '白線とアスファルト', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 391, text: '側溝ふたと舗装の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 392, text: '縁石と車道の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 393, text: '縁石と歩道の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 394, text: '点字ブロックと歩道の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 395, text: 'マンホールと舗装の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 396, text: 'グレーチングと舗装の境界', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 397, text: '舗装の色違いパッチ', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 398, text: '補修跡の舗装', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 399, text: '新しい舗装と古い舗装', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 400, text: 'ひび割れ補修ライン', icon: '🔍', category: '線・模様観察', weight: 800},
    {id: 465, text: '交通安全キャラ看板', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 466, text: '飛び出し注意キャラ看板', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 467, text: '防犯キャラ看板', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 468, text: '防火キャラ看板', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 469, text: '商店街フラッグキャラ', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 470, text: '商店街バナーキャラ', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 471, text: '店先ポップスタンドキャラ', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 472, text: 'アーケード装飾キャラ', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 473, text: 'シャッターキャラ絵', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 474, text: '壁キャライラスト', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 475, text: '公共掲示板キャラ', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 476, text: '案内板横キャラ', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 477, text: '観光案内所キャラ', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 478, text: '公民館掲示キャラ', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 479, text: '地域イベント掲示キャラ', icon: '🔍', category: '街インフラ', weight: 800},
    {id: 480, text: '地域マスコット立て看板', icon: '🔍', category: '街インフラ', weight: 800}
  ],
  ...
  hard: [
    ...
    {id: 369, text: 'ボルト留め', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 370, text: 'ネジ頭', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 371, text: '金具プレート', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 372, text: 'L字金具', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 373, text: '針金のねじり', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 374, text: '結束バンド', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 375, text: 'フック', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 376, text: 'カラビナ風金具', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 377, text: '鎖の接続部', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 378, text: '手すりの継ぎ目', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 379, text: 'フェンスの接合部', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 380, text: '標識柱の根元', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 381, text: 'ガードレールの接合部', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 382, text: 'ベンチの固定金具', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 383, text: '配管クランプ', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 384, text: 'ワイヤー固定具', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 433, text: 'アスファルトとコンクリート', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 434, text: '段差のある縁石', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 435, text: '点字ブロックの端', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 436, text: 'タイルの切り替わり', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 437, text: '色違い舗装', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 438, text: '舗装補修パッチ', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 439, text: '一本ひび', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 440, text: '分岐ひび', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 441, text: '並ぶ側溝ふた', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 442, text: 'グレーチング端', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 443, text: 'マンホール補修跡', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 444, text: '途切れた白線', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 445, text: '歩道ブロック継ぎ目', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 446, text: 'インターロッキング', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 447, text: '縁石の角', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 448, text: '縁石カーブ', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 449, text: '色あせた白線', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 450, text: 'かすれたペイント', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 451, text: 'サビの出た金属', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 452, text: 'サビの流れ跡', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 453, text: 'ヒビの入った縁石', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 454, text: '欠けたコンクリート角', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 455, text: '古い舗装の色差', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 456, text: '重ね塗りされた線', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 457, text: '消えかけたマーク', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 458, text: '交換された舗装', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 459, text: '補修された穴の丸跡', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 460, text: 'ずれたブロック', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 461, text: '傾いたポール', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 462, text: '傾いた看板', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 463, text: '曲がったフェンス', icon: '🔍', category: '痕跡・発見', weight: 600},
    {id: 464, text: '草が生えているすき間', icon: '🔍', category: '痕跡・発見', weight: 600}
  ]
};
