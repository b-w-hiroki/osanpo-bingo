...
const topicDatabase = {
  ...
  easy: [
    ...
    {id: 117, text: 'コーヒーカップ', icon: '🔍', category: '家庭・食べ物', diff: 'easy', season: 'all'},
    {id: 139, text: '低い柵', icon: '🔍', category: '街構造・乗り物', diff: 'easy', season: 'all'},
    {id: 149, text: '新幹線', icon: '🔍', category: '街構造・乗り物', diff: 'easy', season: 'all'},
    {id: 205, text: '縄跳び', icon: '🔍', category: '生活・学校', diff: 'easy', season: 'all'},
    {id: 210, text: '自販機横のゴミ箱', icon: '🔍', category: '痕跡・発見', diff: 'easy', season: 'all'},
    {id: 219, text: '鳥の巣', icon: '🔍', category: '痕跡・発見', diff: 'easy', season: 'all'},
    {id: 245, text: 'マンホール周りの円形補修', icon: '🔍', category: '線・模様観察', diff: 'easy', season: 'all'},
    {id: 259, text: '行き止まり', icon: '🔍', category: '線・模様観察', diff: 'easy', season: 'all'},
    {id: 275, text: '丸い排水穴', icon: '🔍', category: '線・模様観察', diff: 'easy', season: 'all'},
    {id: 277, text: '側溝の落ち葉詰まり', icon: '🔍', category: '線・模様観察', diff: 'easy', season: 'autumn'},
    {id: 346, text: '地面より高いマンホール', icon: '🔍', category: '面・高さ観察', diff: 'easy', season: 'all'},
    {id: 410, text: '右折矢印', icon: '🔍', category: '道路標示・路面表示', diff: 'easy', season: 'all'},
    {id: 432, text: '半分はがれた表示', icon: '🔍', category: '案内・注意表示', diff: 'easy', season: 'all'},
    {id: 467, text: 'ふくろう置き物', icon: '🔍', category: 'キャラクター掲示物', diff: 'easy', season: 'all'},
    {id: 475, text: '公共掲示板キャラ', icon: '🔍', category: '公共施設', diff: 'easy', season: 'all'},
    {id: 495, text: 'カラスよけネット', icon: '🔍', category: 'その他観察', diff: 'easy', season: 'all'},
    ...
    {id: 547, text: '住宅煙突', icon: '🔍', category: '住宅・外構', diff: 'easy', season: 'all'},
    {id: 548, text: '銭湯煙突', icon: '🔍', category: '住宅・外構', diff: 'easy', season: 'all'},
    {id: 551, text: '銀杏', icon: '🔍', category: 'その他観察', diff: 'easy', season: 'autumn'},
    {id: 553, text: 'スーパー', icon: '🔍', category: '商業・店舗', diff: 'easy', season: 'all'},
    {id: 555, text: 'カレー屋さん', icon: '🔍', category: '商業・店舗', diff: 'easy', season: 'all'},
    {id: 565, text: 'ソーラーパネル', icon: '🔍', category: '住宅・外構', diff: 'easy', season: 'all'},
    {id: 584, text: 'ボロボロ三角コーン', icon: '🔍', category: '劣化・補修・ズレ', diff: 'easy', season: 'all'},
    {id: 586, text: '消火器', icon: '🔍', category: '街インフラ', diff: 'easy', season: 'all'},
    {id: 588, text: 'サボテン', icon: '🔍', category: '自然・生き物', diff: 'easy', season: 'all'},
    {id: 589, text: '竹', icon: '🔍', category: '自然・生き物', diff: 'easy', season: 'all'},
    {id: 594, text: '大型ビジョン', icon: '🔍', category: '商業・店舗', diff: 'easy', season: 'all'},
    {id: 601, text: 'バラ（春夏秋）', icon: '🔍', category: '自然・生き物', diff: 'easy', season: 'all'},
    {id: 645, text: 'ヤシの木', icon: '🔍', category: '自然・生き物', diff: 'easy', season: 'all'},
    {id: 650, text: 'ファミマ', icon: '🔍', category: '商業・店舗', diff: 'easy', season: 'all'},
    {id: 663, text: '肉球', icon: '🔍', category: '自然・生き物', diff: 'easy', season: 'all'},
    {id: 665, text: '緑色のコーン', icon: '🔍', category: '案内・注意表示', diff: 'easy', season: 'all'},
    {id: 671, text: '首曲がりミラー', icon: '🔍', category: '街インフラ', diff: 'easy', season: 'all'},
  ],
  // ふつう（93個）
  normal: [
    {id: 2, text: '郵便ポスト', icon: '🔍', category: '街インフラ', diff: 'normal', season: 'all'},
    {id: 19, text: '宅配ボックス', icon: '🔍', category: '街インフラ', diff: 'normal', season: 'all'},
    {id: 23, text: '小さな物置', icon: '🔍', category: '街インフラ', diff: 'normal', season: 'all'},
    {id: 24, text: '家の外階段', icon: '🔍', category: '街インフラ', diff: 'normal', season: 'all'},
    {id: 33, text: '通学路ポール', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 34, text: '公園のベンチ', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 39, text: '小さな白い花', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 42, text: 'どんぐり', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'autumn'},
    {id: 45, text: '丸い葉っぱ', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 46, text: '細長い葉っぱ', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 48, text: '植え込み', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 57, text: '低いポール', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 59, text: '灰皿スタンド', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 66, text: 'ちょうちょ', icon: '🔍', category: '生活・学校', diff: 'normal', season: 'summer'},
    {id: 70, text: 'カタツムリ', icon: '🔍', category: '生活・学校', diff: 'normal', season: 'summer'},
    {id: 73, text: 'のれん', icon: '🔍', category: '生活・学校', diff: 'normal', season: 'all'},
    {id: 74, text: '立て看板', icon: '🔍', category: '生活・学校', diff: 'normal', season: 'all'},
    {id: 77, text: 'シャッター', icon: '🔍', category: '生活・学校', diff: 'normal', season: 'all'},
    {id: 80, text: '店先の箱', icon: '🔍', category: '生活・学校', diff: 'normal', season: 'all'},
    {id: 83, text: 'レジ横の小窓', icon: '🔍', category: '生活・学校', diff: 'normal', season: 'all'},
    {id: 89, text: '校庭フェンス', icon: '🔍', category: '生活・学校', diff: 'normal', season: 'all'},
    ...
    {id: 216, text: '虹反射', icon: '🔍', category: '痕跡・発見', diff: 'normal', season: 'all'},
    {id: 224, text: 'ベンチ下ボール', icon: '🔍', category: '痕跡・発見', diff: 'normal', season: 'all'},
    {id: 280, text: '集水ますのふた', icon: '🔍', category: '線・模様観察', diff: 'normal', season: 'all'},
    {id: 409, text: '左折矢印', icon: '🔍', category: '道路標示・路面表示', diff: 'normal', season: 'all'},
    {id: 414, text: 'スクールゾーン舗装', icon: '🔍', category: '道路標示・路面表示', diff: 'normal', season: 'all'},
    {id: 415, text: '緑舗装', icon: '🔍', category: '道路標示・路面表示', diff: 'normal', season: 'all'},
    {id: 416, text: '赤舗装', icon: '🔍', category: '道路標示・路面表示', diff: 'normal', season: 'all'},
    {id: 430, text: '古いステッカー跡', icon: '🔍', category: '案内・注意表示', diff: 'normal', season: 'all'},
    {id: 461, text: '傾いたポール', icon: '🔍', category: '劣化・補修・ズレ', diff: 'normal', season: 'all'},
    {id: 462, text: '傾いた看板', icon: '🔍', category: '劣化・補修・ズレ', diff: 'normal', season: 'all'},
    {id: 473, text: 'シャッターキャラ絵', icon: '🔍', category: 'キャラクター掲示物', diff: 'normal', season: 'all'},
    {id: 480, text: '地域マスコット立て看板', icon: '🔍', category: '観光・地域情報', diff: 'normal', season: 'all'},
    {id: 485, text: '分別表示', icon: '🔍', category: '生活・地域設備', diff: 'normal', season: 'all'},
    ...
    {id: 525, text: '証明写真機', icon: '🔍', category: 'その他観察', diff: 'normal', season: 'all'},
    {id: 533, text: 'ブロック塀の通気穴', icon: '🔍', category: 'その他観察', diff: 'normal', season: 'all'},
    {id: 550, text: '水門ハンドル', icon: '🔍', category: 'その他観察', diff: 'normal', season: 'all'},
    {id: 556, text: 'ニワトリ', icon: '🔍', category: 'その他観察', diff: 'normal', season: 'all'},
    {id: 561, text: 'のぼりの土台', icon: '🔍', category: '商業・店舗', diff: 'normal', season: 'all'},
    {id: 563, text: 'ココア', icon: '🔍', category: '家庭・食べ物', diff: 'normal', season: 'all'},
    {id: 568, text: 'ネパール国旗', icon: '🔍', category: '観光・地域情報', diff: 'normal', season: 'all'},
    {id: 575, text: '長靴', icon: '🔍', category: '痕跡・発見', diff: 'normal', season: 'all'},
    {id: 578, text: '珍しいポスト', icon: '🔍', category: '街インフラ', diff: 'normal', season: 'all'},
    {id: 580, text: '町中華', icon: '🔍', category: '商業・店舗', diff: 'normal', season: 'all'},
    {id: 583, text: '三角コーン', icon: '🔍', category: '街インフラ', diff: 'normal', season: 'all'},
    {id: 595, text: '閉店セール', icon: '🔍', category: '商業・店舗', diff: 'normal', season: 'all'},
    {id: 609, text: 'どんぐり（秋）', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'autumn'},
    {id: 610, text: 'スズキ（秋）', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'autumn'},
    {id: 611, text: 'カラス', icon: '🔍', category: '生活・学校', diff: 'normal', season: 'all'},
    {id: 612, text: '川', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 614, text: 'カメ', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    ...
    {id: 623, text: '魚', icon: '🔍', category: '自然・生き物', diff: 'normal', season: 'all'},
    {id: 624, text: '青い建物', icon: '🔍', category: '住宅・外構', diff: 'normal', season: 'all'},
    {id: 633, text: '可愛い置物', icon: '🔍', category: 'キャラクター掲示物', diff: 'normal', season: 'all'},
    ...
    {id: 642, text: '電波塔', icon: '🔍', category: '街インフラ', diff: 'normal', season: 'all'},
    {id: 643, text: 'コンテナ', icon: '🔍', category: '生活・地域設備', diff: 'normal', season: 'all'},
    {id: 644, text: 'タワマン', icon: '🔍', category: '住宅・外構', diff: 'normal', season: 'all'},
    {id: 647, text: 'バッティングセンター', icon: '🔍', category: '商業・店舗', diff: 'normal', season: 'all'},
  ...
  // むずかしい（137個）
  hard: [
    {id: 6, text: '飛び出し坊や', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 11, text: '道路反射板', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 12, text: '点字ブロック', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 14, text: '玄関灯', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 15, text: '郵便受け', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 16, text: 'インターホン', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 20, text: '家のフェンス', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 21, text: '窓の格子', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 22, text: '雨どい', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 25, text: 'すべり台', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 35, text: '公園の案内板', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 37, text: 'たんぽぽ', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'spring'},
    {id: 41, text: '松ぼっくり', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 43, text: '苔', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 50, text: '屋外の蛇口', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 58, text: '自動販売機', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 61, text: '猫', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 62, text: '犬', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 63, text: 'すずめ', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 64, text: 'ハト', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 65, text: 'カラス', icon: '🔍', category: '生活・学校', diff: 'hard', season: 'all'},
    {id: 68, text: 'アリ', icon: '🔍', category: '生活・学校', diff: 'hard', season: 'all'},
    {id: 69, text: 'ダンゴムシ', icon: '🔍', category: '生活・学校', diff: 'hard', season: 'all'},
    {id: 76, text: '食品サンプル', icon: '🔍', category: '生活・学校', diff: 'hard', season: 'all'},
    {id: 78, text: 'アーケード', icon: '🔍', category: '生活・学校', diff: 'hard', season: 'all'},
    {id: 88, text: '学校の門', icon: '🔍', category: '生活・学校', diff: 'hard', season: 'all'},
    {id: 91, text: '一輪車', icon: '🔍', category: '生活・学校', diff: 'hard', season: 'all'},
    {id: 93, text: '竹馬', icon: '🔍', category: '生活・学校', diff: 'hard', season: 'all'},
    {id: 98, text: 'ほうき', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 99, text: '傘立て', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 102, text: '室外機', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 107, text: 'ホースリール', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 109, text: 'おにぎり', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 110, text: 'パン', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 111, text: 'サンドイッチ', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 114, text: 'クッキー', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 119, text: 'たい焼き', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 120, text: '焼きいも', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'winter'},
    {id: 124, text: 'チェーン柵', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 125, text: '石橋', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 126, text: '階段', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 127, text: '花壇', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 128, text: '手押しポンプ', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'all'},
    {id: 129, text: '掲示板', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 132, text: '段差プレート', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 134, text: '木製アーチ', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 136, text: '石段', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 141, text: '消火栓', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 144, text: '駐車場ゲート', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 147, text: '自動車', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 150, text: '飛行機', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 153, text: '桜', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'spring'},
    {id: 155, text: 'ひまわり', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'summer'},
    {id: 156, text: 'スイカ', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'summer'},
    {id: 159, text: '雪だるま', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'winter'},
    ...
    {id: 274, text: 'コンクリート側溝', icon: '🔍', category: '住宅・外構', diff: 'hard', season: 'all'},
    {id: 411, text: '自転車ナビライン', icon: '🔍', category: '道路標示・路面表示', diff: 'hard', season: 'all'},
    {id: 419, text: '黄色い注意プレート', icon: '🔍', category: '案内・注意表示', diff: 'hard', season: 'all'},
    {id: 420, text: '赤い注意プレート', icon: '🔍', category: '案内・注意表示', diff: 'hard', season: 'all'},
    {id: 424, text: '避難案内マーク', icon: '🔍', category: '案内・注意表示', diff: 'hard', season: 'all'},
    {id: 426, text: 'コンビニ外観', icon: '🔍', category: '案内・注意表示', diff: 'hard', season: 'all'},
    {id: 428, text: '工事中カラー', icon: '🔍', category: '案内・注意表示', diff: 'hard', season: 'all'},
    {id: 463, text: '曲がったフェンス', icon: '🔍', category: '劣化・補修・ズレ', diff: 'hard', season: 'all'},
    {id: 465, text: '屋外招き猫', icon: '🔍', category: 'キャラクター掲示物', diff: 'hard', season: 'all'},
    {id: 470, text: '商店街バナーキャラ', icon: '🔍', category: 'キャラクター掲示物', diff: 'hard', season: 'all'},
    {id: 472, text: 'アーケード装飾キャラ', icon: '🔍', category: 'キャラクター掲示物', diff: 'hard', season: 'all'},
    ...
    {id: 513, text: '小さなパン屋', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 516, text: '八百屋', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 518, text: '魚屋', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 520, text: 'コインランドリー', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 524, text: '文房具屋', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 552, text: 'ガードレール', icon: '🔍', category: '舗装・縁石・路面状態', diff: 'hard', season: 'all'},
    {id: 554, text: 'ラーメン屋', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 560, text: '手袋（冬）', icon: '🔍', category: '痕跡・発見', diff: 'hard', season: 'winter'},
    ...
    {id: 569, text: 'フランス国旗', icon: '🔍', category: '観光・地域情報', diff: 'hard', season: 'all'},
    {id: 571, text: 'アメリカ国旗', icon: '🔍', category: '観光・地域情報', diff: 'hard', season: 'all'},
    {id: 573, text: 'お寺', icon: '🔍', category: '観光・地域情報', diff: 'hard', season: 'all'},
    {id: 574, text: '神社', icon: '🔍', category: '観光・地域情報', diff: 'hard', season: 'all'},
    {id: 577, text: 'クレープ屋さん', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    ...
    {id: 590, text: '駅', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 591, text: 'パチンコ', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 593, text: 'かかし', icon: '🔍', category: 'その他観察', diff: 'hard', season: 'all'},
    {id: 596, text: 'キッチンカー', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 597, text: '宣伝カー', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 599, text: 'つつじ（春）', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'spring'},
    {id: 602, text: 'チューリップ（春）', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'spring'},
    {id: 603, text: '桜（春）', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'spring'},
    {id: 604, text: 'ユリ（春夏秋）', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 608, text: '時計', icon: '🔍', category: '季節・形・数', diff: 'hard', season: 'all'},
    {id: 613, text: '橋', icon: '🔍', category: '街構造・乗り物', diff: 'hard', season: 'all'},
    {id: 616, text: 'クモの巣', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 618, text: '居酒屋', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 621, text: '歯医者', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 627, text: '学校', icon: '🔍', category: '生活・学校', diff: 'hard', season: 'all'},
    {id: 629, text: 'かき氷（夏）', icon: '🔍', category: '家庭・食べ物', diff: 'hard', season: 'summer'},
    {id: 630, text: '海', icon: '🔍', category: '自然・生き物', diff: 'hard', season: 'all'},
    {id: 634, text: '車両進入禁止', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 636, text: '転回禁止', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 637, text: '追越禁止', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    {id: 640, text: '高さ制限', icon: '🔍', category: '街インフラ', diff: 'hard', season: 'all'},
    ...
    {id: 649, text: 'コンビニ', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    {id: 652, text: 'セブンイレブン', icon: '🔍', category: '商業・店舗', diff: 'hard', season: 'all'},
    ...
    {id: 662, text: '捨てタイヤ', icon: '🔍', category: '劣化・補修・ズレ', diff: 'hard', season: 'all'},
    {id: 664, text: '黄色いコーン', icon: '🔍', category: '案内・注意表示', diff: 'hard', season: 'all'},
  ...
  // おに（108個）
  oni: [
    {id: 5, text: 'カーブミラー', icon: '🔍', category: '街インフラ', diff: 'oni', season: 'all'},
    {id: 13, text: '表札プレート', icon: '🔍', category: '街インフラ', diff: 'oni', season: 'all'},
    {id: 17, text: '門柱', icon: '🔍', category: '街インフラ', diff: 'oni', season: 'all'},
    {id: 26, text: 'ブランコ', icon: '🔍', category: '街インフラ', diff: 'oni', season: 'all'},
    {id: 27, text: 'ジャングルジム', icon: '🔍', category: '街インフラ', diff: 'oni', season: 'all'},
    {id: 28, text: 'シーソー', icon: '🔍', category: '街インフラ', diff: 'oni', season: 'all'},
    {id: 30, text: '砂場', icon: '🔍', category: '街インフラ', diff: 'oni', season: 'all'},
    {id: 32, text: '公園の水飲み場', icon: '🔍', category: '街インフラ', diff: 'oni', season: 'all'},
    {id: 38, text: 'クローバー', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 40, text: '赤い実', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 44, text: '木の切り株', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 49, text: 'ブロック塀', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 51, text: '車止め', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 53, text: '木の案内札', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 54, text: '金網フェンス', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 55, text: '手すり', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 56, text: '駐輪ラック', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 71, text: 'トカゲ', icon: '🔍', category: '生活・学校', diff: 'oni', season: 'all'},
    {id: 72, text: 'メダカ鉢', icon: '🔍', category: '生活・学校', diff: 'oni', season: 'all'},
    {id: 79, text: 'ガチャガチャ', icon: '🔍', category: '生活・学校', diff: 'oni', season: 'all'},
    {id: 81, text: 'テイクアウト窓口', icon: '🔍', category: '生活・学校', diff: 'oni', season: 'all'},
    {id: 82, text: '商店街の旗', icon: '🔍', category: '生活・学校', diff: 'oni', season: 'all'},
    {id: 84, text: '店のライト', icon: '🔍', category: '生活・学校', diff: 'oni', season: 'all'},
    {id: 87, text: '通学路標識', icon: '🔍', category: '生活・学校', diff: 'oni', season: 'all'},
    {id: 92, text: 'サッカーボール', icon: '🔍', category: '生活・学校', diff: 'oni', season: 'all'},
    {id: 105, text: '園芸鉢', icon: '🔍', category: '家庭・食べ物', diff: 'oni', season: 'all'},
    {id: 130, text: '案内地図', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'all'},
    {id: 135, text: 'ガーデンランプ', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'all'},
    {id: 140, text: '防火水槽ふた', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'all'},
    {id: 143, text: 'タクシー乗り場', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'all'},
    {id: 145, text: '自転車', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'all'},
    {id: 148, text: 'トラック', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'all'},
    {id: 152, text: '船', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'all'},
    {id: 157, text: '銀杏', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'autumn'},
    {id: 158, text: '木の葉の山', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'autumn'},
    {id: 161, text: '紅葉', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'autumn'},
    {id: 163, text: '止まれ足型マーク', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 164, text: 'マフラー', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'winter'},
    {id: 166, text: 'クリスマス飾り', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'winter'},
    {id: 167, text: '風鈴', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'summer'},
    {id: 168, text: 'うちわ', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'summer'},
    {id: 169, text: '赤いボール', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 170, text: '段ボール箱', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 172, text: 'お地蔵さん', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 174, text: '大きな岩', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 175, text: '渦巻きオブジェ', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 177, text: '星プレート', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 178, text: '顔に見える石', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 179, text: '直線の棒', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 180, text: 'しましま板', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 209, text: '屋外喫煙所', icon: '🔍', category: '痕跡・発見', diff: 'oni', season: 'all'},
    {id: 212, text: '銅像', icon: '🔍', category: '痕跡・発見', diff: 'oni', season: 'autumn'},
    {id: 213, text: '枝の風船', icon: '🔍', category: '痕跡・発見', diff: 'oni', season: 'all'},
    {id: 214, text: 'しぼんだボール', icon: '🔍', category: '痕跡・発見', diff: 'oni', season: 'all'},
    {id: 222, text: '抜け殻', icon: '🔍', category: '痕跡・発見', diff: 'oni', season: 'summer'},
    {id: 225, text: '柵のタオル', icon: '🔍', category: '痕跡・発見', diff: 'oni', season: 'all'},
    {id: 257, text: '十字路', icon: '🔍', category: '線・模様観察', diff: 'oni', season: 'all'},
    {id: 258, text: 'T字路', icon: '🔍', category: '線・模様観察', diff: 'oni', season: 'all'},
    {id: 262, text: '急な坂', icon: '🔍', category: '線・模様観察', diff: 'oni', season: 'all'},
    {id: 406, text: 'ひし形マーク', icon: '🔍', category: '道路標示・路面表示', diff: 'oni', season: 'all'},
    {id: 418, text: '注意色のしましま', icon: '🔍', category: '案内・注意表示', diff: 'oni', season: 'all'},
    {id: 421, text: '青い案内プレート', icon: '🔍', category: '案内・注意表示', diff: 'oni', season: 'all'},
    {id: 422, text: '緑の誘導表示', icon: '🔍', category: '案内・注意表示', diff: 'oni', season: 'all'},
    ...
    {id: 469, text: '商店街フラッグキャラ', icon: '🔍', category: 'キャラクター掲示物', diff: 'oni', season: 'all'},
    ...
    {id: 489, text: 'トレー回収箱', icon: '🔍', category: '生活・地域設備', diff: 'oni', season: 'all'},
    {id: 490, text: '牛乳パック回収箱', icon: '🔍', category: '生活・地域設備', diff: 'oni', season: 'all'},
    {id: 501, text: '側溝コンクリ穴フタ', icon: '🔍', category: '道路・路面', diff: 'oni', season: 'all'},
    {id: 514, text: '個人ケーキ屋', icon: '🔍', category: '商業・店舗', diff: 'oni', season: 'all'},
    {id: 515, text: '惣菜屋', icon: '🔍', category: '商業・店舗', diff: 'oni', season: 'all'},
    {id: 517, text: '町の肉屋', icon: '🔍', category: '商業・店舗', diff: 'oni', season: 'all'},
    {id: 519, text: 'クリーニング店', icon: '🔍', category: '商業・店舗', diff: 'oni', season: 'all'},
    {id: 522, text: '昔ながらの美容室入口', icon: '🔍', category: 'その他観察', diff: 'oni', season: 'all'},
    {id: 557, text: 'バスケットゴール', icon: '🔍', category: 'その他観察', diff: 'oni', season: 'all'},
    {id: 558, text: 'ネイルショップ', icon: '🔍', category: '商業・店舗', diff: 'oni', season: 'all'},
    {id: 559, text: '軍手', icon: '🔍', category: '痕跡・発見', diff: 'oni', season: 'all'},
    {id: 562, text: 'トマトジュース', icon: '🔍', category: '家庭・食べ物', diff: 'oni', season: 'all'},
    ...
    {id: 581, text: 'おしるこ缶（冬）', icon: '🔍', category: '家庭・食べ物', diff: 'oni', season: 'winter'},
    {id: 587, text: '靴屋さん', icon: '🔍', category: '商業・店舗', diff: 'oni', season: 'all'},
    {id: 592, text: 'ビニールハウス', icon: '🔍', category: 'その他観察', diff: 'oni', season: 'all'},
    {id: 598, text: 'つばき（冬）', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'winter'},
    {id: 600, text: 'あじさい（夏）', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'summer'},
    {id: 605, text: 'コスモス（秋）', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'autumn'},
    {id: 606, text: '50の数字', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 607, text: '100の数字', icon: '🔍', category: '季節・形・数', diff: 'oni', season: 'all'},
    {id: 615, text: '公衆電話', icon: '🔍', category: '生活・地域設備', diff: 'oni', season: 'all'},
    {id: 619, text: '広葉樹', icon: '🔍', category: '自然・生き物', diff: 'oni', season: 'all'},
    {id: 625, text: 'タクシー', icon: '🔍', category: '街構造・乗り物', diff: 'oni', season: 'all'},
    {id: 626, text: '消防署', icon: '🔍', category: '公共施設', diff: 'oni', season: 'all'},
    {id: 628, text: 'レンガの建物', icon: '🔍', category: '住宅・外構', diff: 'oni', season: 'all'},
    {id: 631, text: '落とし物', icon: '🔍', category: '痕跡・発見', diff: 'oni', season: 'all'},
    {id: 632, text: '動物の遊具', icon: '🔍', category: '生活・地域設備', diff: 'oni', season: 'all'},
