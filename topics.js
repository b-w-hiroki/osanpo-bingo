...
const topicDatabase = {
  ...
  1: [
    ...
    {id: 110, text: 'パン', icon: '🔍', category: '家庭・食べ物', diff: 1, season: 'all'},
    ...
    {id: 253, text: '雑草が出たすき間', icon: '🔍', category: '線・模様観察', diff: 1, season: 'all'},
    ...
    {id: 280, text: '集水ますのふた', icon: '🔍', category: '線・模様観察', diff: 1, season: 'all'},
    ...
    {id: 442, text: 'グレーチング端', icon: '🔍', category: '舗装・縁石・路面状態', diff: 1, season: 'all'},
    {id: 469, text: '住宅街フラッグキャラ', icon: '🔍', category: 'キャラクター掲示物', diff: 1, season: 'all', fields: ['residential']},
    {id: 470, text: '住宅街バナーキャラ', icon: '🔍', category: 'キャラクター掲示物', diff: 1, season: 'all', fields: ['residential']},
    ...
    {id: 684, text: 'ゴミ袋', icon: '🔍', category: 'その他観察', diff: 1, season: 'all'},
    {id: 685, text: '自転車カバー', icon: '🔍', category: 'その他観察', diff: 1, season: 'all'},
    {id: 686, text: '電柱の広告', icon: '🔍', category: 'その他観察', diff: 1, season: 'all'},
    {id: 687, text: '赤い花', icon: '🔍', category: 'その他観察', diff: 1, season: 'all'},
    {id: 688, text: '黄色い花', icon: '🔍', category: 'その他観察', diff: 1, season: 'all'},
    ...
    {id: 695, text: 'アンテナ', icon: '🔍', category: 'その他観察', diff: 1, season: 'all', fields: ['residential']},
    {id: 696, text: 'パラボラアンテナ', icon: '🔍', category: 'その他観察', diff: 1, season: 'all', fields: ['residential']},
    {id: 698, text: '擁壁（ようへき）', icon: '🔍', category: 'その他観察', diff: 1, season: 'all', fields: ['residential']},
    {id: 700, text: '水抜き穴', icon: '🔍', category: 'その他観察', diff: 1, season: 'all', fields: ['residential']},
    {id: 702, text: 'コーンバー', icon: '🔍', category: 'その他観察', diff: 1, season: 'all'},
    {id: 718, text: '線路', icon: '🔍', category: 'その他観察', diff: 1, season: 'all', fields: ['residential']},
    {id: 720, text: '定礎', icon: '🔍', category: 'その他観察', diff: 1, season: 'all'},
  ],
  // ティア2（ふつう・160個）
  2: [
    ...
    {id: 82, text: '住宅街の旗', icon: '🔍', category: '生活・学校', diff: 2, season: 'all'},
    ...
    {id: 119, text: 'たい焼き', icon: '🔍', category: '家庭・食べ物', diff: 2, season: 'all'},
    {id: 120, text: '焼きいも', icon: '🔍', category: '家庭・食べ物', diff: 2, season: 'winter'},
    {id: 135, text: 'ガーデンランプ', icon: '🔍', category: '街構造・乗り物', diff: 2, season: 'all'},
    {id: 136, text: '石段', icon: '🔍', category: '街構造・乗り物', diff: 2, season: 'all'},
    {id: 140, text: '防火水槽ふた', icon: '🔍', category: '街構造・乗り物', diff: 2, season: 'all'},
    ...
    {id: 166, text: 'クリスマス飾り', icon: '🔍', category: '季節・形・数', diff: 2, season: 'winter'},
    ...
    {id: 180, text: 'しましま板', icon: '🔍', category: '季節・形・数', diff: 2, season: 'all'},
    {id: 202, text: '木漏れ日', icon: '🔍', category: '痕跡・発見', diff: 2, season: 'all'},
    {id: 209, text: '屋外喫煙所', icon: '🔍', category: '痕跡・発見', diff: 2, season: 'all'},
    {id: 223, text: 'きのこ群', icon: '🔍', category: '痕跡・発見', diff: 2, season: 'autumn', fields: ['residential']},
    ...
    {id: 699, text: '土のう', icon: '🔍', category: 'その他観察', diff: 2, season: 'all', fields: ['residential']},
    {id: 705, text: '粗大ゴミ', icon: '🔍', category: 'その他観察', diff: 2, season: 'all', fields: ['residential']},
    {id: 713, text: '工事', icon: '🔍', category: 'その他観察', diff: 2, season: 'all'},
    {id: 715, text: 'メッシュシート', icon: '🔍', category: 'その他観察', diff: 2, season: 'all'},
    {id: 716, text: '中洲', icon: '🔍', category: 'その他観察', diff: 2, season: 'all', fields: ['residential']},
  ],
  // ティア3（むずかしい・81個）
  3: [
    ...
    {id: 112, text: 'アイスクリーム', icon: '🔍', category: '家庭・食べ物', diff: 3, season: 'all'},
    ...
    {id: 701, text: '水抜き穴から草', icon: '🔍', category: 'その他観察', diff: 3, season: 'all', fields: ['residential']},
    {id: 703, text: 'ツタまみれの建物', icon: '🔍', category: 'その他観察', diff: 3, season: 'all', fields: ['residential']},
    {id: 704, text: '法枠工擁壁', icon: '🔍', category: 'その他観察', diff: 3, season: 'all', fields: ['residential']},
    {id: 706, text: '給水塔', icon: '🔍', category: 'その他観察', diff: 3, season: 'all', fields: ['residential']},
    {id: 709, text: 'ゴム製のタイヤ止め', icon: '🔍', category: 'その他観察', diff: 3, season: 'all'},
    {id: 711, text: 'ソフトクリーム置物', icon: '🔍', category: 'その他観察', diff: 3, season: 'all'},
    {id: 712, text: 'タイル壁', icon: '🔍', category: 'その他観察', diff: 3, season: 'all'},
    {id: 717, text: '根固めブロック', icon: '🔍', category: 'その他観察', diff: 3, season: 'all', fields: ['residential']},
  ...
  4: [
    ...
    {id: 111, text: 'サンドイッチ', icon: '🔍', category: '家庭・食べ物', diff: 4, season: 'all'},
    ...
    {id: 697, text: '蛇の抜け殻', icon: '🔍', category: 'その他観察', diff: 4, season: 'all', fields: ['residential']},
    {id: 707, text: '一部がない店名', icon: '🔍', category: 'その他観察', diff: 4, season: 'all'},
    {id: 708, text: 'どこにも繋がってない階段', icon: '🔍', category: 'その他観察', diff: 4, season: 'all'},
    {id: 710, text: '杉玉', icon: '🔍', category: 'その他観察', diff: 4, season: 'all'},
    {id: 714, text: '家の基礎', icon: '🔍', category: 'その他観察', diff: 4, season: 'all', fields: ['residential']},
    {id: 719, text: '収納式車止め', icon: '🔍', category: 'その他観察', diff: 4, season: 'all'},
