...
const topicDatabase = {
  ...
  normal: [
    ...
    {id: 578, text: 'ポスト', icon: '🔍', category: '街インフラ', diff: 'normal', season: 'all'},
  ...
  hard: [
    ...
    {id: 470, text: '住宅街バナーキャラ', icon: '🔍', category: 'キャラクター掲示物', diff: 'hard', season: 'all'},
  ...
  oni: [
    ...
    {id: 82, text: '住宅街の旗', icon: '🔍', category: '生活・学校', diff: 'oni', season: 'all'},
